...
public class Track implements Parcelable
{
    ...
    public final static Parcelable.Creator<Track> CREATOR = new Creator<Track>() {
        ...
        public Track createFromParcel(Parcel in) {
            ...
            instance.trackMbid = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackIsrc = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackSpotifyId = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackSoundcloudId = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackXboxmusicId = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackName = ((String) in.readValue((String.class.getClassLoader())));
            in.readList(instance.trackNameTranslationList, (java.lang.Object.class.getClassLoader()));
            instance.trackRating = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.trackLength = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.commontrackId = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.instrumental = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.explicit = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.hasLyrics = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.hasLyricsCrowd = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.hasSubtitles = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.hasRichsync = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.numFavourite = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.lyricsId = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.subtitleId = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.albumId = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.albumName = ((String) in.readValue((String.class.getClassLoader())));
            instance.artistId = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.artistMbid = ((String) in.readValue((String.class.getClassLoader())));
            instance.artistName = ((String) in.readValue((String.class.getClassLoader())));
            instance.albumCoverart100x100 = ((String) in.readValue((String.class.getClassLoader())));
            instance.albumCoverart350x350 = ((String) in.readValue((String.class.getClassLoader())));
            instance.albumCoverart500x500 = ((String) in.readValue((String.class.getClassLoader())));
            instance.albumCoverart800x800 = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackShareUrl = ((String) in.readValue((String.class.getClassLoader())));
            instance.trackEditUrl = ((String) in.readValue((String.class.getClassLoader())));
            instance.commontrackVanityId = ((String) in.readValue((String.class.getClassLoader())));
            instance.restricted = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.firstReleaseDate = ((String) in.readValue((String.class.getClassLoader())));
            instance.updatedTime = ((String) in.readValue((String.class.getClassLoader())));
            instance.primaryGenres = ((PrimaryGenres) in.readValue((PrimaryGenres.class.getClassLoader())));
            instance.secondaryGenres = ((SecondaryGenres) in.readValue((SecondaryGenres.class.getClassLoader())));
            return instance;
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(trackIsrc);
        dest.writeValue(trackSpotifyId);
        dest.writeValue(trackSoundcloudId);
        dest.writeValue(trackXboxmusicId);
        dest.writeValue(trackName);
        dest.writeList(trackNameTranslationList);
        ...
        dest.writeValue(primaryGenres);
        dest.writeValue(secondaryGenres);
    }
